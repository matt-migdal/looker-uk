view: by_card_underlying_symbol_yy {
  derived_table: {
    ...
    sql:
       ...
       SELECT und.symbol,
              ...
              und.ya_gbp_spend_amount as prev_gbp_spend_amount,
              und.ya_cad_spend_amount as prev_cad_spend_amount,
              und.ya_usd_spend_amount as prev_usd_spend_amount,
              und.ya_eur_spend_amount as prev_eur_spend_amount,
              und.ya_dkk_spend_amount as prev_dkk_spend_amount,
              und.ya_nok_spend_amount as prev_nok_spend_amount,
              und.ya_jpy_spend_amount as prev_jpy_spend_amount,
              und.ya_sek_spend_amount as prev_sek_spend_amount,
              und.ya_pln_spend_amount as prev_pln_spend_amount,
              und.ptd_spend_yoy,
              und.trans_count,
        ...
        (SELECT * FROM ${by_card_underlying_symbol_manda_emax_rolling.SQL_TABLE_NAME}

        UNION ALL

        SELECT * FROM ${by_card_underlying_symbol_reg_emax_rolling.SQL_TABLE_NAME}

        UNION ALL

        SELECT * FROM ${by_card_underlying_symbol_manda_constind_rolling.SQL_TABLE_NAME}

        UNION ALL

        SELECT * FROM ${by_card_underlying_symbol_reg_constind_rolling.SQL_TABLE_NAME}) und
